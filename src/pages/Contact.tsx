...
export default function ContactPage() {
  ...
  return (
    <>
      {/* ✅ SEO */}
      <Helmet>
        <title>Contact Pamoja Ebenezer College | Apply via WhatsApp Tanzania</title>
        <meta
          name="description"
          content="Contact Pamoja Ebenezer College in Babati, Tanzania. Apply for vocational training in agriculture, sewing, animal health, and computer studies via WhatsApp or phone."
        />
        <meta
          name="keywords"
          content="contact college Tanzania, apply vocational training Tanzania, Babati college contact, NACTVET college Tanzania"
        />
        <meta property="og:title" content="Contact Pamoja Ebenezer College" />
        <meta
          property="og:description"
          content="Reach Pamoja Ebenezer College for admissions and vocational training applications in Tanzania."
        />
