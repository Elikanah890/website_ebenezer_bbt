  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Pamoja Ebenezer College offers vocational training in agriculture, sewing, animal health, and computer studies in Tanzania. Apply now and gain practical skills for real-world careers."
        />
        <meta
          name="keywords"
          content="college Tanzania, agriculture training Tanzania, vocational education Tanzania, NACTVET courses, sewing training, computer studies Tanzania"
        />
      ...
      <main>
        ...
        <section className="relative min-h-[90vh] lg:min-h-screen flex items-center">
          <div className="absolute inset-0">
            <img
              src={heroBg}
              alt="Students learning agriculture in Tanzania"
