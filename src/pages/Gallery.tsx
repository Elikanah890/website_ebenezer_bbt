...
import { Helmet } from "react-helmet-async"; // ✅ ADDED SEO
...
export default function GalleryPage() {
  ...
  return (
    <>
      {/* ✅ SEO META */}
      <Helmet>
        <title>Gallery | Pamoja Ebenezer College Tanzania</title>
        <meta
          name="description"
          content="Explore campus life, classrooms, workshops, farm training, events, and graduation moments at Pamoja Ebenezer College in Tanzania."
        />
        <meta
          name="keywords"
          content="college gallery Tanzania, campus photos Babati, vocational training images, agriculture college photos"
        />
        <link rel="canonical" href="https://pamojebenezercollege.ac.tz/gallery" />

        {/* Open Graph */}
        <meta property="og:title" content="Gallery | Pamoja Ebenezer College" />
        <meta property="og:description" content="Explore campus life and student activities in Tanzania." />
              ...
              {filtered.map((img, i) => (
                <ScrollReveal key={`${img.src}-${filter}`} delay={i * 50}>
                  ...
                  >
                    <img
                      src={img.src}
                      alt={`${img.caption} - ${img.category} at Pamoja Ebenezer College`}
